...
ResultsText[3] = {
  messianic: {
    catTitle: "Messianic Primal",
    catIntro:
      "You have a zealous attachment to a mission that is not necessarily grounded in solid projections and reliable facts. You have the capacity to see yourself as destined for a unique mission that drives you. Messianic Primals are guided by a singular calling to achieve a seemingly unreachable goal, fix a daunting problem, and change the world. It’s more than passionate! This is a living and breathing concept. Being an MP has to be somewhat selfish. As an MP you are interested in connecting with people who can help you along the way of your big goals. Messianic Primals sacrifice to save and inspire others. They filter out the noise and answer to a <i>greater</i> calling. They are determined to solve the unsolvable. Messianic Primals ask themselves these two questions in some shape or form: <u>First</u>, what’s wrong with the world? <u>Second</u>, what can I do to fix it?",
    rangeInfo: {
      high:
    ...
    tips: [
      "<u>Primal Tip for MP’s #1:</u> When you wake up in the morning ask yourself: What can I be more messianic about today? Recognize that raw Primal energy, if not harnessed, can be as destructive as it is empowering.",
...
ResultsText[4] = {
  insecure: {
    ...
    tips: [
      ...
      "<u>Primal Tip for IP’s #4:</u> <strong>Know what you don’t know!</strong> Take a page out of the insecure Primals playbook and avoid overconfidence, accept when you are an imposter, and be prudently paranoid. By practicing these precepts and operating on the bleeding edge of uncertainty, you will be more successful.",
    ],
  },
};
ResultsText[5] = {
  nuts: {
    catTitle: "Nuts Primal",
    catIntro:
      "You march to your own drum. You are <u>not</u> literally mentally ill, and this is never to be used in any pejorative form, but you are solely the <u>good</u> kind of crazy. Successful people are f*ing nuts. This is the <i>good</i> side of craziness. A Nuts Primal is willing to take chances that no careful or rational person would ever advise. NP’s are <i>rare souls</i> who follow their dreams, no matter how seemingly crazy, insane, or downright dangerous they might be. Nuts Primals may allow civilization to rein in their worst impulses, but screw it! You are the ultimate risk-taker, eccentric, and misfit. Congratulations.",
    rangeInfo: {
      high:
...
ResultsText[6] = {
  gallant: {
    catTitle: "Gallant Primal",
    catIntro:
      "You combine both courage and nobility, and protect those to whom you’re loyal and who are loyal to you. Being a Gallant Primal is perhaps our most primal instinct of all! Well done. You prioritize doing the right thing for others and going to the favor bank for a withdrawal. Gallant Primals measure impact by <i>how much good you do for others</i>. Being a GP can mean taking enormous risks to commit your life to helping others. Gallant Primals are noble to others without expecting reciprocation. GP’s feel a moral responsibility to make others’ needs and concerns your own. We need more of you!",
    rangeInfo: {
      high:
