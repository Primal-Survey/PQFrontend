...
ResultsText[0] = {
  relentless: {
    ...
    tips: [
      "<u>Primitive Tip for RP’s #1:</u> Practice the “<strong>five-to-one</strong>” rule: for every five unavoidable meetings in conference rooms with agendas and PowerPoint presentations, have one work playdate. Not necessarily drunken karaoke or catching a silly movie with a colleague, but getting together with someone or a team of people you like--friend, vendor, partner, boss, employee—and bouncing ideas around in an environment that isn’t the office and doesn’t feel restrictive.",

      "<u>Primitive Tip for RP’s #2:</u> Make a habit of scheduling regular meetups with friends and colleagues—whether it’s coffee, lunch, after-work drinks, or ski trips. It might sound trivial, but that old-fashioned social interaction can be as important to your overall health as hitting the gym. Play in real life! Playing around with people you enjoy connecting with is an excellent way to work that childlike muscle and escape whatever professional rut you may be stuck in.",

      "<u>Primitive Tip for RP’s #3:</u> Rather than being quick to forgive slights and forget failures, find a physical object that reminds you of a past setback and look at it once a week. Reflect on your hardships, remember your difficult beginnings, and use them to fuel your progression.",

      "<u>Primitive Tip for RP’s #4:</u> Think like a door-to-door salesperson, not a Wall Street Banker. Focus on the quality and variety of the conversations with key stakeholders that will keep them coming back, not just the quality of your bottom line. Take your work personally.",
    ],
  },
};
ResultsText[1] = {
  oppositional: {
    ...
    tips: [
      "<u>Primitive Tip for OP’s #1:</u> For teams, break off into small units and be willing to debate and criticize. This will produce the most creative solutions! Debate and criticism do not inhibit ideas, but rather stimulate them relative to every other condition. This is essential!",

      "<u>Primitive Tip for OP’s #2:</u> For business owners, take note when executives are insulated from criticism. Pierce that veil by asking too many questions! Don’t be afraid to be irritating. Realize that asking questions is not a sign of weakness but healthy curiosity and interest in getting to the bottom of things. Learn to get better at asking questions. Those who never ask questions and dutifully follow orders often fare worse in the long run.",

      "<u>Primitive Tip for OP’s #3:</u> Ask <i>nontrivial questions</i>, those that demonstrate intelligence, a drive to learn, and curiosity. But be careful not to sound accusatory. Be respectful and focused on the answer while being oppositional.",

      "<u>Primitive Tip for OP’s #4:</u> Set <i>redlines</i> and hold yourself accountable to them. Don’t be afraid to re-establish new redlines, even if it means sacrificing short-term goals.",
    ],
  },
};
ResultsText[2] = {
...
ResultsText[3] = {
  messianic: {
    ...
    tips: [
      "<u>Primitive Tip for MP’s #1:</u> When you wake up in the morning ask yourself: What can I be more messianic about today? Recognize that raw Primitive energy, if not harnessed, can be as destructive as it is empowering.",

      "<u>Primitive Tip for MP’s #2:</u> Set one goal that you might find <i>extraordinary</i> and out of reach. Think about what keeps you up at night, what keeps you tossing and turning. Then write that down.",

      "<u>Primitive Tip for MP’s #3:</u> Think about what you are doing now. What is the biggest, grandest thing you can make that job into? What can your role become? What can it grow into? Write down these thoughts and keep them safe, you’ll need them later!",

      "<u>Primitive Tip for MP’s #4:</u> Perform the “<strong>waive a magic wand</strong>” exercise by envisioning something that replaces and reinvents your current situation. Doing this will clarify your core values and provide a strongly needed reality check for how much progress is being made. This will help put your battles in context. This is the first step toward making a solution appear tangible instead of theoretical.",
    ],
  },
};
ResultsText[4] = {
  insecure: {
    ...
    tips: [
      "<u>Primitive Tip for IP’s #1:</u> Check your arrogance at the door! Be willing to apologize and open a dialogue about your flaws or insecurities whenever you gut says so.",

      "<u>Primitive Tip for IP’s #2:</u> Ask for feedback constantly. Own your insecurities/flaws and transform them into strengths. Use them to connect with others.",

      "<u>Primitive Tip for IP’s #3:</u> Realize that a small dose of “impostor syndrome” can sometimes be a positive force. Experiencing self-doubt indicates you are challenging yourself. You are venturing outside your comfort zone. You are growing and experiencing new and exciting things. Be comfortable reaching out to others for support when things get too overwhelming. ",

      "<u>Primitive Tip for IP’s #4:</u> <strong>Know what you don’t know!</strong> Take a page out of the insecure Primitives playbook and avoid overconfidence, accept when you are an imposter, and be prudently paranoid. By practicing these precepts and operating on the bleeding edge of uncertainty, you will be more successful.",
    ],
  },
};
ResultsText[5] = {
  nuts: {
    ...
    tips: [
      "<u>Primitive Tip for NP’s #1:</u> Take a moment and think: what would be your childish response to a recent compilation? Jot that down immediately. If there weren’t any rules, how would you go about solving it? Now consider: what exactly is holding you back?",

      "<u>Primitive Tip for NP’s #2:</u> For those still <i>choosing</i> a career path, find something you are natural at and then milk it as much as humanly possible. Relentless Primitives often do not have the patience to learn a new skill from scratch; they find something they are good at and then search for a way to monetize it. Try the same! When you focus on what you are good at, work inherently becomes more personal. You become valued for a skill you possess, and you can make more money doing that.",

      "<u>Primitive Tip for NP’s #3:</u> Begin each day by laying out precisely what you want to accomplish. Only then do you open your inbox and determine what can wait a day, a week, or a month. Focus solely on what can help you meet your <i>big goals</i> for the day, even if you piss some people off in the process.",

      "<u>Primitive Tip for NP’s #4:</u> Go on “playdates” with friends/colleagues/employees that leave you charged up, excited, and ready to take on the world. Grown-ups have meetings that leave you drained, rarely seeming to accomplish anything. A relentless company nurtures independent thinking, where pitching new ideas and rethinking age-old techniques is not only tolerated but encouraged.",
    ],
  },
};
ResultsText[6] = {
  gallant: {
    ...
    catIntro:
      "You combine both courage and nobility, and protect those to whom you’re loyal and who are loyal to you. Being a Gallant Primitive is perhaps our most Primitive instinct of all! Well done. You prioritize doing the right thing for others and going to the favor bank for a withdrawal. Gallant Primitives measure impact by <i>how much good you do for others</i>. Being a GP can mean taking enormous risks to commit your life to helping others. Gallant Primitives are noble to others without expecting reciprocation. GP’s feel a moral responsibility to make others’ needs and concerns your own. We need more of you!",
    rangeInfo: {
      high:
    ...
    tips: [
      "<u>Primitive Tip for GP’s #1:</u> Try making a gallant move each day. Train yourself to be a better coworker, a better friend, and a better person. This may be calling a family member, helping someone in need, or doing a random act of kindness. But try to do one per day.",

      "<u>Primitive Tip for GP’s #2:</u> Instead of, or at least, in addition to, cursing the constraints foisted upon you, try to draw some inspiration from them. By seeing barriers as opportunities, you might be more inclined to develop imaginative ideas.",

      "<u>Primitive Tip for GP’s #3:</u> Wrestle with constraints, do not try to escape them. Use them as building blocks. Physical vulnerability and psychological unease are often traits of success. Being forced to navigate a unique set of circumstances can make you likely to reach pinnacles in your field.",

      "<u>Primitive Tip for GP’s #4:</u> Hitting pause on your current career trajectory does not just mean taking a breather during lunch. It can also mean stopping to reassess the weeks, months, and years ahead. Take frequent breaks to reexamine your situation. Never stop reassessing.",
    ],
  },
};
