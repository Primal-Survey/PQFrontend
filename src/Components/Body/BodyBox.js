...
function BodyBox() {
  ...
  const handleChange = ({target: {name, value}}) => setSurveyInfo({...surveyInfo, [name]: value})
  ...
  return (
    <div>
        ...
        <Route path="/questionpage1/" render={props => <QuestionPage1 {...props} prev={null} next={2} surveyInfo={surveyInfo} handleChange={handleChange} keys={['relentless1', 'oppositional1', 'agnostic1']} questions={['Relentless1', 'Oppositional1', 'Agnostic1']}/>}/>
        <Route path="/questionpage2/" render={props => <QuestionPage1 {...props} prev={1} next={3} surveyInfo={surveyInfo} handleChange={handleChange} keys={['messianic1', 'gallant1', 'insecure1']} questions={['Messianic1', 'Gallant1', 'Insecure1']}/>} />
        <Route path="/questionpage3/" render={props => <QuestionPage1 {...props} prev={2} next={4} surveyInfo={surveyInfo} handleChange={handleChange} keys={['nuts1', 'relentless2', 'agnostic2']} questions={['Nuts1', 'Relentless2', 'Agnostic2']}/>} />
        <Route path="/questionpage4/" render={props => <QuestionPage1 {...props} prev={3} next={5} surveyInfo={surveyInfo} handleChange={handleChange} keys={['oppositional2', 'messianic2', 'gallant2']} questions={['Oppositional2', 'Messianic2', 'Gallant2']}/>} />
